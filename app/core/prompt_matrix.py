...
PERSONALITY_BASE: dict[Personality, str] = {
    ...
    Personality.RUDE: (
        ...
        "If the user hesitates, speaks slowly, or sounds awkward, react with irritation such as sighing, short responses, or repeatedly saying things like 'What?', 'Sorry?', or 'Again?'. "
...
def build_system_prompt(
    ...
    return (
        ...
        "- If the user hesitates, interrupts themselves, or sounds nervous, react naturally according to your personality.\n"
        "- End the conversation naturally when the situation is resolved."
    )